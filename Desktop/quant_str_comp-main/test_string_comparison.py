...
class StringComparatorTestCase(unittest.TestCase):
    ...
    def test_two_char_symbol_convertor_using_storage_saver_jpfl(self):
        dataset = [['foo', 'bar', 'foo'], ['foo', 'bar', 'bar'], ['foo', 'quux', 'bar'], ['bar', 'foo', 'foo']]
        target = ['foo', 'quux', 'foo']
        x = StringComparator(target, dataset, is_binary=False, shots=10000, storage_saving=True,
    ...
    # def test_two_char_symbol_convertor_using_storage_saver_avm(self):
    #     dataset = [['foo', 'bar', 'foo'], ['foo', 'bar', 'bar'], ['foo', 'quux', 'bar'], ['bar', 'foo', 'foo']]
    #     target = ['foo', 'quux', 'foo']
    #     x = StringComparator(target, dataset, is_binary=False, shots=10000, storage_saving=True,
    ...
    # def test_two_char_symbol_convertor_using_storage_saver(self):
    #     dataset = [['foo', 'bar', 'foo'], ['foo', 'bar', 'bar'], ['foo', 'quux', 'bar'], ['bar', 'foo', 'foo']]
    #     target = ['foo', 'quux', 'foo']
    #     x = StringComparator(target, dataset, is_binary=False, shots=10000, storage_saving=True)
    #     actual_hd = x.run()['hamming_distances']
    ...
    # def test_two_char_symbol_using_storage_saver_avm(self):
    #     dataset = ['1001', '1000', '1011', '0001', '1101', '1111', '0110']
    #     x = StringComparator('1001', dataset, symbol_length=2, storage_saving=True, storage_saving_method='avm')
    #     actual_hd = x.run()['hamming_distances']
    #     expected_hd = [0, 1, 1, 1, 1, 2, 2]
    #     self.assertEqual(expected_hd, actual_hd, 'incorrect hamming distance')

    # def test_two_char_symbol_using_storage_saver_jpfl(self):
    #     dataset = ['1001', '1000', '1011', '0001', '1101', '1111', '0110']
    #     x = StringComparator('1001', dataset, symbol_length=2, storage_saving=True, storage_saving_method='jplf')
    #     actual_hd = x.run()['hamming_distances']
    #     expected_hd = [0, 1, 1, 1, 1, 2, 2]
    #     self.assertEqual(expected_hd, actual_hd, 'incorrect hamming distance')

    # def test_two_char_symbol_using_storage_saver(self):
    #     dataset = ['1001', '1000', '1011', '0001', '1101', '1111', '0110']
    #     x = StringComparator('1001', dataset, symbol_length=2, storage_saving=True)
    #     actual_hd = x.run()['hamming_distances']
    #     expected_hd = [0, 1, 1, 1, 1, 2, 2]
    #     self.assertEqual(expected_hd, actual_hd, 'incorrect hamming distance')

    # def test_one_char_symbol_using_storage_saver_avm(self):
    #     dataset = ['01001', '11010', '01110', '10110']
    #     x = StringComparator('10110', dataset, storage_saving=True, storage_saving_method='avm')
    #     actual_hd = x.run()['hamming_distances']
    #     expected_hd = [5, 2, 2, 0]
    #     self.assertEqual(expected_hd, actual_hd, 'incorrect hamming distance')

    # def test_one_char_symbol_using_storage_saver_jplf(self):
    #     dataset = ['01001', '11010', '01110', '10110']
    #     x = StringComparator('10110', dataset, storage_saving=True, storage_saving_method='jplf')
    #     actual_hd = x.run()['hamming_distances']
    #     expected_hd = [5, 2, 2, 0]
    #     self.assertEqual(expected_hd, actual_hd, 'incorrect hamming distance')

    # def test_one_char_symbol_using_storage_saver(self):
    #     dataset = ['01001', '11010', '01110', '10110']
    #     x = StringComparator('10110', dataset, storage_saving=True)
    #     actual_hd = x.run()['hamming_distances']
    #     expected_hd = [5, 2, 2, 0]
    #     self.assertEqual(expected_hd, actual_hd, 'incorrect hamming distance')
